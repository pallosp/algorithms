...
static void IsPrimeMillerRabin_uint32_max(benchmark::State &state) {
  for (auto _ : state)
    for (unsigned i = 0; i < 100; i++)
      is_prime_miller_rabin(UINT_MAX - i);
}
